        ...
        <div class="container">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h1 class="panel-title">Página no encontrada - Error 404</h1>
                </div>
                ...
                <div class="panel-body" id="panel-principal">
                    ...
                    <div class="col-md-4">
                        <div class="col-md-12" id="ocultarLinea">-</div>
                        <div class="col-md-12" id="ocultarLinea">-</div>
                        <span><img src="/Generico-ITT/img/error404b.png" id="errorImagen"></span>
                    </div>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="col-md-10" >
                                <span id="errorPrincipal">¡Página no encontrada!</span>
                            </div>

                            <div class="col-md-12" >
                                <span id="errorPagina">No hemos podido encontrar la página que está buscando.</span>
                            </div>

                            <div class="col-md-12" >
                                <br><span id="errorContacto">No puede visualizar la página si se encuentra fuera del Instituto.</span>
                            </div>

                            <div class="col-md-12" id="errorCodigoG" >
                                <br><span>Código de error: <span id="errorCodigo">404</span></span>
                            </div>
