...
public class ReportesEventos_Srv extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Evento_MB> evento = Eventos_ReportesEventos_DAO.consultar( );    
        ...
        String jrxmlFile = getClass().getClassLoader().getResource("Reportes/evento2.jrxml").toString().substring(6);   
