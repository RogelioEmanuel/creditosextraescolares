                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">     
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="/creditosextraescolares/app/actividades/listaractividadesdisponibles.do"><span class="fa fa-user dropdown-item"></span>Actividades Disponibles</a></li>
