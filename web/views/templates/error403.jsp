<!-- 
    Document   : error403
    Created on : 19/10/2016, 04:21:45 PM
    Author     : Ángel Careaga <angelcaareaga@gmail.com>
-->
        ...
        <div class="container">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h1 class="panel-title">Acceso denegado - Error 403</h1>
                </div>
                ...
                <div class="panel-body" id="panel-principal">
                    ...
                    <div class="col-md-4">
                        <div class="col-md-12" id="ocultarLinea">-</div>
                        <div class="col-md-12" id="ocultarLinea">-</div>
                        <span><img src="/Generico-ITT/img/error403.png" id="errorImagen"></span>
                    </div>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="col-md-10" >
                                <span id="errorPrincipal">¡Acceso denegado!</span>
                            </div>

                            <div class="col-md-12" >
                                <span id="errorPagina">Usted no tiene privilegios suficientes para visualizar esta página.</span>
                            </div>
                            ...
                            <div class="col-md-12" id="errorCodigoG" >
                                <br><span>Código de error: <span id="errorCodigo">403</span></span>
                            </div>
