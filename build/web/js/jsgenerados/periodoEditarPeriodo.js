...
$("#FormEditarPeriodo").on("click", "#btnRegistrar", function (evento) {
    ...
    editarDatosMaestro(periodo,fechaInicio,insscripcion,fechaFin,cierre,departamento,promocion);
...
function editarDatosMaestro(periodo,fechaInicio,insscripcion,fechaFin,cierre,departamento,promocion) {
    $("#pageLoader").show();
    var datos={
        periodo: periodo,
